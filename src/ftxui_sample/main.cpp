...
// configuration step. It creates a namespace called `TempC_Proj`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", TempC_Proj::cmake::project_name, TempC_Proj::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", TempC_Proj::cmake::project_version);
      return EXIT_SUCCESS;
    }
